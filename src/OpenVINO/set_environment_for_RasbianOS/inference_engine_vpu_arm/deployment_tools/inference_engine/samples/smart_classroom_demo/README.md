...
./smart_classroom_demo -m_act <path_to_model>/person-detection-action-recognition-0005.xml \
                       ...
                       -i <path_to_video>
```
> **NOTE**: To recognize actions of students, use `person-detection-action-recognition-0003` model.
...
./smart_classroom_demo -m_act <path_to_model>/person-detection-action-recognition-teacher-0002.xml \
                       ...
                       -i <path_to_video>
```
> **NOTE**: To recognize actions of a teacher, use `person-detection-action-recognition-teacher-0001` model.
