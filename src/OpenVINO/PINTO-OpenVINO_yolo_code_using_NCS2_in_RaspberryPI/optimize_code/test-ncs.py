...
def bollardFunc(result):
    result = "볼라드"
    fp = open("input.txt", "w+")
    data = ("전방에 %s 있습니다. 조심하세요." % result) 
    fp.write(data) 
    fp.close()
...
class NcsWorker(object):
    def __init__(self, devid, frameBuffer, results, camera_width, camera_height, number_of_ncs, vidfps):
        ...
        self.model_xml = "/home/pi/Downloads/160000-train-model/frozen_darknet_yolov3_model.xml"
        self.model_bin = "/home/pi/Downloads/160000-train-model/frozen_darknet_yolov3_model.bin"
...
if __name__ == '__main__':
    ...
    camera_width = 1024 #320
    camera_height = 768 #240
    vidfps = 30
