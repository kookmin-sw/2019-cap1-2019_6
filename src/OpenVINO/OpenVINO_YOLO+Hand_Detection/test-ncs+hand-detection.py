...
def im_trim(img, y):
    ...
    cv2.imwrite('screenshot.jpg', resize)
    fingerFunc()
...
class NcsWorker(object):
    ...
    def __init__(self, devid, frameBuffer, results, camera_width, camera_height, number_of_ncs, vidfps):
        ...
        self.model_xml = "/home/pi/Downloads/FP16-original-model/frozen_tiny_yolo_v3.xml"
        self.model_bin = "/home/pi/Downloads/FP16-original-model/frozen_tiny_yolo_v3.bin"
